	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="brief introduction" prop="introduction">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="brief introduction" prop="introduction">
					<span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.introduction}}</span>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="content" prop="content">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.content" label="content" prop="content">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				content: [
					{ required: true, message: 'contentCannot be empty', trigger: 'blur' },
				],
			}
		};
	},
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../springbootc004o809/upload');
        } else {
