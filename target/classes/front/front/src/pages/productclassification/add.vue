    ...
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="product class" prop="productclassification">
            <el-input v-model="ruleForm.productclassification" 
                placeholder="product class" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('productclassification/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('productclassification/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('productclassification/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
