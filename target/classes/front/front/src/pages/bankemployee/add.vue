...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="department" prop="department">
            <el-input v-model="ruleForm.department" 
                placeholder="department" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Professional title" prop="professionaltitle">
            <el-input v-model="ruleForm.professionaltitle" 
                placeholder="Professional title" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="network" prop="branch">
            <el-input v-model="ruleForm.branch" 
                placeholder="network" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='department'){
              this.ruleForm.department = obj[o];
              this.ro.department = true;
              continue;
            }
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('bankemployee/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('bankemployee/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('bankemployee/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
