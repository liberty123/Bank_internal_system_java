...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Exam topic " prop="examtopic">
            <el-input v-model="ruleForm.examtopic" 
                placeholder="Exam topic " clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}'  label="Exam Type" prop="examtype">
            <el-select v-model="ruleForm.examtype" placeholder="Please select Exam Type"  >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Exam time" prop="examtime" >
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Examination location" prop="examlocation">
            <el-input v-model="ruleForm.examlocation" 
                placeholder="Examination location" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="link" prop="link">
            <el-input v-model="ruleForm.link" 
                placeholder="link" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('examnotice/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('examnotice/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
