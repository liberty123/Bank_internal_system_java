...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px 10px 0","margin":"0 0 10px","alignItems":"center","flexWrap":"wrap","display":"flex","width":"100%","height":"auto"}'>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
        ...
        <el-input v-model="formSearch.nickname" placeholder="Username" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"alignItems":"center","margin":"0 4px 0 0","display":"flex"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>No.Comment content</div>
        <el-input v-model="formSearch.content" placeholder="No.Comment content" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('discusswealthmanagementproducts','add')" :style='{"cursor":"pointer","border":"8px inset #ffc766","padding":"0px 15px","margin":"0 10px 0 0","outline":"none","color":"#333","borderRadius":"4px","background":"#fff","width":"auto","fontSize":"14px","lineHeight":"32px","height":"45px"}' type="primary" @click="add('/index/discusswealthmanagementproductsAdd')"><i v-if="true" :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>add</el-button>
    </el-form>
  ...
  export default {
    ...
    data() {
      return {
        ...
        breadcrumbItem: [
          {
            name: 'wealthmanagementproducts评论表'
          }
        ],
        formSearch: {
          nickname: '',
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        this.$http.get('discusswealthmanagementproducts/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/discusswealthmanagementproductsDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
