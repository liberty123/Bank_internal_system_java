...
<div :style='{"width":"90%","padding":"30px 0px 40px","margin":"10px auto","position":"relative","background":"rgba(255,255,255,.0)"}'>
    <el-form
      ...
      label-width="120px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="bank name" prop="bankname">
            <el-input v-model="ruleForm.bankname" 
                placeholder="bank name" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Bank type" prop="banktype">
            <el-input v-model="ruleForm.banktype" 
                placeholder="Bank type" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="Telephone" prop="contactphone">
            <el-input v-model="ruleForm.contactphone" 
                placeholder="Telephone" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="business hours" prop="businesshours">
            <el-input v-model="ruleForm.businesshours" 
                placeholder="business hours" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' label="brief introduction" prop="introduction">
            <editor 
...
<script>
  export default {
    ...
    methods: {
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            if(o=='bankname'){
              this.ruleForm.bankname = obj[o];
              this.ro.bankname = true;
              continue;
            }
            if(o=='banktype'){
              this.ruleForm.banktype = obj[o];
              this.ro.banktype = true;
              continue;
            }
            if(o=='branchaddress'){
            ...
            if(o=='businesshours'){
              this.ruleForm.businesshours = obj[o];
              this.ro.businesshours = true;
              continue;
            }
            if(o=='cover'){
    ...
    // 多级联动参数
      // 多级联动参数
      info(id) {
        this.$http.get('bankoutlet/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 跨表计算
                          ...
                          this.$http.post('bankoutlet/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
