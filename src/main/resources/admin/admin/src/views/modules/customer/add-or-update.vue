	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.touxiang" label="head sculpture" prop="touxiang">
					<file-upload
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.touxiang" label="head sculpture" prop="touxiang">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="intention" prop="intention">
					<el-input v-model="ruleForm.intention" placeholder="intention" clearable  :readonly="ro.intention"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="intention" prop="intention">
					<el-input v-model="ruleForm.intention" placeholder="intention" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="deposit" prop="deposit">
					<el-input v-model="ruleForm.deposit" placeholder="deposit" clearable  :readonly="ro.deposit"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="deposit" prop="deposit">
					<el-input v-model="ruleForm.deposit" placeholder="deposit" readonly></el-input>
				</el-form-item>
			</template>
