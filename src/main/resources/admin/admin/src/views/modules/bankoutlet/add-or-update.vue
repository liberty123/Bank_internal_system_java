<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="bank name" prop="bankname">
					<el-input v-model="ruleForm.bankname" placeholder="bank name" clearable  :readonly="ro.bankname"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="bank name" prop="bankname">
					<el-input v-model="ruleForm.bankname" placeholder="bank name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Bank type" prop="banktype">
					<el-input v-model="ruleForm.banktype" placeholder="Bank type" clearable  :readonly="ro.banktype"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="Bank type" prop="banktype">
					<el-input v-model="ruleForm.banktype" placeholder="Bank type" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="business hours" prop="businesshours">
					<el-input v-model="ruleForm.businesshours" placeholder="business hours" clearable  :readonly="ro.businesshours"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="business hours" prop="businesshours">
					<el-input v-model="ruleForm.businesshours" placeholder="business hours" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="brief introduction" prop="introduction">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="brief introduction" prop="introduction">
                    <span :style='{"fontSize":"16px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.introduction"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.introduction = this.ruleForm.introduction.replace(reg,'../../../springbootc004o809/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `bankoutlet/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.bankoutletCrossAddOrUpdateFlag = false;
						 this.parent.search();
