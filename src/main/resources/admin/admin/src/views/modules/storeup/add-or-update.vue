<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230329/eff4ea96c952463cb46b9c79d043ce56.gif) fixed,#f6f6f6"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="name" prop="name">
					<el-input v-model="ruleForm.name" placeholder="name" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="name" prop="name">
					<el-input v-model="ruleForm.name" placeholder="name" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture" label="image" prop="picture">
					<file-upload
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture" label="image" prop="picture">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="Recommend Type" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder="Recommend Type" clearable  :readonly="ro.inteltype"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="Recommend Type" prop="inteltype">
					<el-input v-model="ruleForm.inteltype" placeholder="Recommend Type" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="notes" prop="remark">
					<el-input v-model="ruleForm.remark" placeholder="notes" clearable  :readonly="ro.remark"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="notes" prop="remark">
					<el-input v-model="ruleForm.remark" placeholder="notes" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				name: [
					{ required: true, message: 'nameCannot be empty', trigger: 'blur' },
				],
				picture: [
					{ required: true, message: 'imageCannot be empty', trigger: 'blur' },
				],
				type: [
				],
				inteltype: [
