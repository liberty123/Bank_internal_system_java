		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 0px"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","margin":"0 auto 20px","borderRadius":"3px","textAlign":"center","background":"none","display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						...
						<el-input v-model="searchForm.productclassification" placeholder="product class" clearable></el-input>
					</div>
			...
			<!-- <div> -->
				<el-table class="tables"
					...
					v-if="isAuth('productclassification','view')"
					:data="dataList"
...
export default {
  ...
  methods: {
    ...
    getDataList() {
      ...
      this.$http({
        url: "productclassification/page",
        method: "get",
        params: params
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    deleteHandler(id) {
      ...
      this.$confirm(`Are you sure to proceed with[${id ? "del" : "batchdel"}]operate?`, "tiitle", {
        ...
        this.$http({
          url: "productclassification/delete",
          method: "post",
          data: ids
        }).then(({ data }) => {
          if (data && data.code === 0) {
